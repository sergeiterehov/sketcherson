...
export default function ArcIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle cx="12" cy="12" r="2" fill={iconColor.basic} />
      <circle cx="6.5" cy="6.5" r="1.5" fill={iconColor.basic} />
      <circle cx="17.5" cy="17.5" r="1.5" fill={iconColor.basic} />
      <path
